...
//
//        NomalSort ns = new NomalSort();
//        int result = ns.compare(s);
//        System.out.println(result);

//        String message = "x-3 X0001";
//        String message = "123-456-7890 123+456+7890";
//        String message = "xYz000123J XyZ+123j";
//        String message = "#$%^&*[]- abcdefgh";
//        String message = "Abc47jKL+00123 ABC+47jkL123";

//        String message = "0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789 +123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789";
//        String message = "X+0000000000000000000000000000000000000000000000000 x-000000000000000000000000";
//        String message = "11111111111111111111111111111111111111111111111111111111 99999999999999999999999999999999999999999999999";
//        String message = "abc[ ABC{";
//        String message = "#$%^&*(){}00001234#$%^&*(){}00001234 #$%^&*(){}1234#$%^&*(){}123";
...
//        NomalSort1 ns1 = new NomalSort1();
        int result;
        for(int i=0; i < index; i++){
            Main ns1 = new Main();
            message = scan.nextLine();
            result = ns1.compare( message.toUpperCase() );
//            result = ns1.compare( message.toUpperCase() );
